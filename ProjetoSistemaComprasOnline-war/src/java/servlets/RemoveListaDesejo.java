...
@WebServlet(name = "RemoveListaDesejo", urlPatterns = {"/RemoveListaDesejo"})
public class RemoveListaDesejo extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Long idLista = Long.parseLong(request.getParameter("idLista"));
            ...
            try {
                    ...
                    listaDesejo.setId(idLista);
                    
                    ejbListaDesejo.excluir(listaDesejo);
